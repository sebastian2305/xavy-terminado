...
Venue.create!([
  {name: "Crossfit elefante atlético", description: "Salvaje y majestuoso", phone: "6145454"},
  {name: "Yoga la nutria serena", description: "Tranquilo, desde la rama de un árbol.", phone: "4526545"},
  {name: "El mapache feliz", description: "Centro de escalada animal.", phone: "2124705"},
